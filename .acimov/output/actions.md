...
|Pointer|<pre lang="Turtle">:isMembershipOf a owl:ObjectProperty ;&#10;rdfs:label "est l'appartenance à",&#10;"is membership of" ;&#10;rdfs:comment "A relation that refers to the Agent involved in a Membership." ;&#10;rdfs:domain :Membership ;&#10;rdfs:isDefinedBy :regulation ;&#10;rdfs:range :Agent .<br/></pre>|
|Pointer|<pre lang="Turtle">:isMembershipIn a owl:ObjectProperty ;&#10;rdfs:label "est l'appartenance à",&#10;"is membership in" ;&#10;rdfs:comment "A relation that refers to the Group involved in a Membership." ;&#10;rdfs:domain :Membership ;&#10;rdfs:isDefinedBy :regulation ;&#10;rdfs:range :Group .<br/></pre>|
...
|Pointer|<pre lang="Turtle">[dc:bibliographicCitation "Chemero, A., & Turvey, M. T. (2007). Complexity, hypersets, and the ecological perspective on perception-action. Biological Theory, 2(1), 23-36."@en ;&#10; rdfs:label "Chemero and Turvey, 2007"@en]<br/></pre>|
...
|Title|OWL QL Profile incompatible|
|Description|Anonymous individuals are not supported|
|Pointer|<pre lang="Turtle">[dc:bibliographicCitation "Norman, D. (2013). The design of everyday things: Revised and expanded edition. Basic books."@en ;&#10; rdfs:label "Norman, 2013"@en]<br/></pre>|
...
|Title|Too close terms|
|Description|The following terms are too similar: :isMembershipOf and :isMembershipIn|
|Pointer|<pre lang="Turtle">:isMembershipOf a owl:ObjectProperty ;&#10;rdfs:label "est l'appartenance à",&#10;"is membership of" ;&#10;rdfs:comment "A relation that refers to the Agent involved in a Membership." ;&#10;rdfs:domain :Membership ;&#10;rdfs:isDefinedBy :regulation .<br/></pre>|
|Pointer|<pre lang="Turtle">:isMembershipIn a owl:ObjectProperty ;&#10;rdfs:label "est l'appartenance à",&#10;"is membership in" ;&#10;rdfs:comment "A relation that refers to the Group involved in a Membership." ;&#10;rdfs:domain :Membership ;&#10;rdfs:isDefinedBy :regulation .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:OrganizationModel a skos:Concept ;&#10;skos:definition "An Organization Model is the combination of Roles, Missions, and Facilities in a consistent way used to enact one or multiple Organizations." ;&#10;skos:editorialNote "The Organization Model is represented as SHACL Shapes." ;&#10;skos:prefLabel "organization model" ;&#10;skos:related :Organization .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:signifies a owl:ObjectProperty ;&#10;rdfs:label "signifie",&#10;"signifies" ;&#10;rdfs:comment "A relation between a signifier and a node shape specifying a description of the expected behavior execution." ;&#10;rdfs:domain :Signifier ;&#10;rdfs:isDefinedBy :interaction ;&#10;rdfs:range sh:NodeShape .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:interaction a owl:Ontology ;&#10;cc:license <https://creativecommons.org/licenses/by/4.0/> ;&#10;dct:contributor <http://ns.inria.fr/fabien.gandon#me>,&#10;<https://pod.inrupt.com/andreiciortea/profile/card#me>,&#10;<https://pod.inrupt.com/smnmyr/profile/card#me> ;&#10;dct:creator <https://danaivach.inrupt.net/profile/card#me> ;&#10;dct:description "An ontology to describe interaction in Hypermedia Multi-Agent Systems.",&#10;"L'ontologie pour décrire l'interaction dans les systèmes multi-agents hypermédias." ;&#10;dct:issued "2023-01-13" ;&#10;dct:title "Hypermedia MAS Interaction Ontology",&#10;"Ontologie d'Interaction des SMA Hypermédias" ;&#10;vann:preferredNamespacePrefix "hmas" ;&#10;vann:preferredNamespaceUri : ;&#10;owl:imports :core .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:fipa a owl:Ontology ;&#10;vann:preferredNamespacePrefix "hmas" ;&#10;vann:preferredNamespaceUri : ;&#10;owl:imports :core .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:hasServiceName a owl:ObjectProperty ;&#10;rdfs:label "has Service Name" ;&#10;rdfs:domain :APService .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:APService a owl:Class ;&#10;rdfs:label "Agent Platform Service" ;&#10;rdfs:comment "A service exposed by a FIPA Agent Platform as defined by the FIPA Abstract Architecture Specification (http://fipa.org/specs/fipa00001/SC00001L.html)." .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:hasServiceType a owl:ObjectProperty ;&#10;rdfs:label "has Service Type" ;&#10;rdfs:domain :APService .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:AgentIdentifierDescription a owl:Class ;&#10;rdfs:label "Agent Identifier Description" ;&#10;rdfs:comment "A resource profile that describes an agent using the Agent Identifier Description defined by the FIPA Agent Management Specification (http://fipa.org/specs/fipa00023/SC00023K.html)." ;&#10;rdfs:subClassOf <https://ci.mines-stetienne.fr/hmas#ResourceProfile> .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:AgentPlatformDescription a owl:Class ;&#10;rdfs:label "Agent Platform Description" ;&#10;rdfs:comment "A resource profile that descripe a FIPA Agent Platform using the Agent Platform Description defined by the FIPA Agent Management Specification (http://fipa.org/specs/fipa00023/SC00023K.html)." ;&#10;rdfs:subClassOf <https://ci.mines-stetienne.fr/hmas#ResourceProfile> .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:FIPAAgentPlatform a owl:Class ;&#10;rdfs:label "FIPA Agent Platform" ;&#10;rdfs:comment "A platform that conforms to the FIPA Abstract Architecture Specification (http://fipa.org/specs/fipa00001/SC00001L.html)." ;&#10;rdfs:subClassOf <https://ci.mines-stetienne.fr/hmas#Platform> .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:HTTPMessageTransportService a owl:Class ;&#10;rdfs:label "HTTP Message Transport Service" ;&#10;rdfs:comment "An HTTP-based message transport service that confirms to the FIPA Agent Message Transport Protocol for HTTP Specification (http://fipa.org/specs/fipa00084/SC00084F.html)." ;&#10;rdfs:subClassOf :MessageTransportService .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:MessageTransportService a owl:Class ;&#10;rdfs:label "Message Transport Service" ;&#10;rdfs:comment "A service for transporting messages among agents that conforms to the FIPA Message Transport Service Specification (http://fipa.org/specs/fipa00067/SC00067F.html)." ;&#10;rdfs:subClassOf :APService .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:IIOPMessageTransportService a owl:Class ;&#10;rdfs:label "IIOP Message Transport Service" ;&#10;rdfs:comment "An HTTP-based message transport service that confirms to the FIPA Agent Message Transport Protocol for IIOP Specification (http://fipa.org/specs/fipa00075/SC00075G.html)." ;&#10;rdfs:subClassOf :MessageTransportService .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:core a owl:Ontology ;&#10;cc:license <https://creativecommons.org/licenses/by/4.0/> ;&#10;dct:contributor <http://maxime-lefrancois.info/me#>,&#10;<http://ns.inria.fr/fabien.gandon#me>,&#10;<http://w3id.org/people/az/me>,&#10;<https://danaivach.inrupt.net/profile/card#me>,&#10;<https://id.inrupt.com/smnmyr>,&#10;<https://orcid.org/0000-0002-2956-0533>,&#10;<https://orcid.org/0000-0002-4506-2745>,&#10;<https://orcid.org/0000-0003-0821-6095>,&#10;<https://www.vcharpenay.link/#me> ;&#10;dct:creator <https://id.inrupt.com/andreiciortea> ;&#10;dct:description "An ontology to describe Hypermedia Multi-Agent Systems.",&#10;"Une ontologie pour la description de systèmes multi-agents hypermédias." ;&#10;dct:issued "2021-11-21" ;&#10;dct:title "Hypermedia MAS Core Ontology",&#10;"Ontologie Centrale des SMA Hypermédias" ;&#10;vann:preferredNamespacePrefix "hmas" ;&#10;vann:preferredNamespaceUri : .<br/></pre>|
...
|Title|Terms not labeled|
|Description|The term :Affordance has no rdfs:label to define it in natural language|
|Pointer|<pre lang="Turtle">:Affordance a skos:Concept ;&#10;dct:references "n496961321fd04c67a18c6b2a50d06175b1",&#10;"n496961321fd04c67a18c6b2a50d06175b2",&#10;"n9c1560d6de8741dc86bbfb78675e107eb1",&#10;"n9c1560d6de8741dc86bbfb78675e107eb2" ;&#10;rdfs:isDefinedBy :core ;&#10;skos:definition "A behavior possibility that is a relationship between an ability of an agent and a situation that includes agents and features of the environment." ;&#10;skos:editorialNote "The concept has been considered as a candidate term for representing interaction cues and metadata in the Hypermedia MAS Core Ontology. The term :Signifier is selected instead for the following reasons: 1) Affordances emerge upon the presence of individual agents in the appropriate situation, while signifiers are defined with respect to agent types to preserve the evolvability and reusability of interaction cues without requiring prior knowledge about individual agents; 2) Affordances are defined in [Chemero and Turvey, 2007] for studying interactions of animals, while signifiers are defined here for supporting interactions of autonomous agents, which exhibit more heterogeneous abilities than animals — including agents whose cognitive abilities exclusively rely on computational processes such as reasoning over representations. Here, the concept is provided to support the discussion, management, and modelling of signifiers, which reveal information about affordances [Norman, 2013]. For example, the association between the two terms enables examining the dynamic exposure of signifiers based on the run-time availability of agent abilities and situations, or the modelling of signifiers that reveal information about affordances for both artificial and human agents." ;&#10;skos:historyNote "The definition of the concept follows affordance theorists [Chemero and Turvey, 2007]." ;&#10;skos:prefLabel "affordance" ;&#10;skos:related :Signifier .<br/></pre>|
...
|Title|OWL QL Profile incompatible|
|Description|Anonymous individuals are not supported|
|Pointer|<pre lang="Turtle">&#60;https://purl.org/hmas/Affordance> a skos:Concept ;&#10; dc:references [a owl:NamedIndividual ;&#10; dc:bibliographicCitation "Chemero, A., & Turvey, M. T. (2007). Complexity, hypersets, and the ecological perspective on perception-action. Biological Theory, 2(1), 23-36."@en ;&#10; dc:identifier &#60;https://doi.org/10.1162/biot.2007.2.1.23> ;&#10; rdfs:label "Chemero and Turvey, 2007"@en] ;&#10; dc:references [a owl:NamedIndividual ;&#10; dc:bibliographicCitation "Norman, D. (2013). The design of everyday things: Revised and expanded edition. Basic books."@en ;&#10; dc:identifier &#60;https://mitpress.mit.edu/9780262640374/> ;&#10; rdfs:label "Norman, 2013"@en] ;&#10; dc:references kg:Noneb20280 ;&#10; dc:references kg:Noneb20281 ;&#10; rdfs:isDefinedBy &#60;https://purl.org/hmas/core> ;&#10; skos:definition "A behavior possibility that is a relationship between an ability of an agent and a situation that includes agents and features of the environment."@en ;&#10; skos:editorialNote "The concept has been considered as a candidate term for representing interaction cues and metadata in the Hypermedia MAS Core Ontology. The term :Signifier is selected instead for the following reasons: 1) Affordances emerge upon the presence of individual agents in the appropriate situation, while signifiers are defined with respect to agent types to preserve the evolvability and reusability of interaction cues without requiring prior knowledge about individual agents; 2) Affordances are defined in [Chemero and Turvey, 2007] for studying interactions of animals, while signifiers are defined here for supporting interactions of autonomous agents, which exhibit more heterogeneous abilities than animals — including agents whose cognitive abilities exclusively rely on computational processes such as reasoning over representations. Here, the concept is provided to support the discussion, management, and modelling of signifiers, which reveal information about affordances [Norman, 2013]. For example, the association between the two terms enables examining the dynamic exposure of signifiers based on the run-time availability of agent abilities and situations, or the modelling of signifiers that reveal information about affordances for both artificial and human agents."@en ;&#10; skos:historyNote "The definition of the concept follows affordance theorists [Chemero and Turvey, 2007]."@en ;&#10; skos:prefLabel "affordance"@en ;&#10; skos:related &#60;https://purl.org/hmas/Signifier><br/></pre>|
...
|Pointer|<pre lang="Turtle">:isHostedOn a owl:AsymmetricProperty,&#10;owl:ObjectProperty ;&#10;rdfs:label "est hébergé sur",&#10;"is hosted on" ;&#10;rdfs:comment "A relation that refers to the platform that hosts an information resource or a process.",&#10;"A relations that refers to the platform that hosts the resource. " ;&#10;rdfs:domain :Hostable ;&#10;rdfs:isDefinedBy :core ;&#10;rdfs:range :HypermediaMASPlatform ;&#10;owl:inverseOf :hosts .<br/></pre>|
...
|Title|Terms not labeled|
|Description|The term :Affordance has no rdfs:label to define it in natural language|
|Pointer|<pre lang="Turtle">:Affordance a skos:Concept ;&#10;dct:references "n7a1d6484331e402b8b9b9b658222b0a3b1",&#10;"n7a1d6484331e402b8b9b9b658222b0a3b2" ;&#10;rdfs:isDefinedBy :core ;&#10;skos:definition "A behavior possibility that is a relationship between an ability of an agent and a situation that includes agents and features of the environment." ;&#10;skos:editorialNote "The concept has been considered as a candidate term for representing interaction cues and metadata in the Hypermedia MAS Core Ontology. The term :Signifier is selected instead for the following reasons: 1) Affordances emerge upon the presence of individual agents in the appropriate situation, while signifiers are defined with respect to agent types to preserve the evolvability and reusability of interaction cues without requiring prior knowledge about individual agents; 2) Affordances are defined in [Chemero and Turvey, 2007] for studying interactions of animals, while signifiers are defined here for supporting interactions of autonomous agents, which exhibit more heterogeneous abilities than animals — including agents whose cognitive abilities exclusively rely on computational processes such as reasoning over representations. Here, the concept is provided to support the discussion, management, and modelling of signifiers, which reveal information about affordances [Norman, 2013]. For example, the association between the two terms enables examining the dynamic exposure of signifiers based on the run-time availability of agent abilities and situations, or the modelling of signifiers that reveal information about affordances for both artificial and human agents." ;&#10;skos:historyNote "The definition of the concept follows affordance theorists [Chemero and Turvey, 2007]." ;&#10;skos:prefLabel "affordance" ;&#10;skos:related :Signifier .<br/></pre>|
...
|Title|Terms not labeled|
|Description|The term :Affordance has no rdfs:label to define it in natural language|
|Pointer|<pre lang="Turtle">:Affordance a skos:Concept ;&#10;dct:references "nf704b7ee663840da96ea9f21e73a2797b1",&#10;"nf704b7ee663840da96ea9f21e73a2797b2" ;&#10;rdfs:isDefinedBy :core ;&#10;skos:definition "A behavior possibility that is a relationship between an ability of an agent and a situation that includes agents and features of the environment." ;&#10;skos:editorialNote "The concept has been considered as a candidate term for representing interaction cues and metadata in the Hypermedia MAS Core Ontology. The term :Signifier is selected instead for the following reasons: 1) Affordances emerge upon the presence of individual agents in the appropriate situation, while signifiers are defined with respect to agent types to preserve the evolvability and reusability of interaction cues without requiring prior knowledge about individual agents; 2) Affordances are defined in [Chemero and Turvey, 2007] for studying interactions of animals, while signifiers are defined here for supporting interactions of autonomous agents, which exhibit more heterogeneous abilities than animals — including agents whose cognitive abilities exclusively rely on computational processes such as reasoning over representations. Here, the concept is provided to support the discussion, management, and modelling of signifiers, which reveal information about affordances [Norman, 2013]. For example, the association between the two terms enables examining the dynamic exposure of signifiers based on the run-time availability of agent abilities and situations, or the modelling of signifiers that reveal information about affordances for both artificial and human agents." ;&#10;skos:historyNote "The definition of the concept follows affordance theorists [Chemero and Turvey, 2007]." ;&#10;skos:prefLabel "affordance" ;&#10;skos:related :Signifier .<br/></pre>|
...
|Title|Terms not labeled|
|Description|The term :Affordance has no rdfs:label to define it in natural language|
|Pointer|<pre lang="Turtle">:Affordance a skos:Concept ;&#10;dct:references "n459690ee72ca407a941feeb121fa93cdb1",&#10;"n459690ee72ca407a941feeb121fa93cdb2" ;&#10;rdfs:isDefinedBy :core ;&#10;skos:definition "A behavior possibility that is a relationship between an ability of an agent and a situation that includes agents and features of the environment." ;&#10;skos:editorialNote "The concept has been considered as a candidate term for representing interaction cues and metadata in the Hypermedia MAS Core Ontology. The term :Signifier is selected instead for the following reasons: 1) Affordances emerge upon the presence of individual agents in the appropriate situation, while signifiers are defined with respect to agent types to preserve the evolvability and reusability of interaction cues without requiring prior knowledge about individual agents; 2) Affordances are defined in [Chemero and Turvey, 2007] for studying interactions of animals, while signifiers are defined here for supporting interactions of autonomous agents, which exhibit more heterogeneous abilities than animals — including agents whose cognitive abilities exclusively rely on computational processes such as reasoning over representations. Here, the concept is provided to support the discussion, management, and modelling of signifiers, which reveal information about affordances [Norman, 2013]. For example, the association between the two terms enables examining the dynamic exposure of signifiers based on the run-time availability of agent abilities and situations, or the modelling of signifiers that reveal information about affordances for both artificial and human agents." ;&#10;skos:historyNote "The definition of the concept follows affordance theorists [Chemero and Turvey, 2007]." ;&#10;skos:prefLabel "affordance" ;&#10;skos:related :Signifier .<br/></pre>|
...
|Title|Terms not labeled|
|Description|The term :Affordance has no rdfs:label to define it in natural language|
|Pointer|<pre lang="Turtle">:Affordance a skos:Concept ;&#10;dct:references "n2e868287d6c44e348ef30beb86d997c7b1",&#10;"n2e868287d6c44e348ef30beb86d997c7b2" ;&#10;rdfs:isDefinedBy :core ;&#10;skos:definition "A behavior possibility that is a relationship between an ability of an agent and a situation that includes agents and features of the environment." ;&#10;skos:editorialNote "The concept has been considered as a candidate term for representing interaction cues and metadata in the Hypermedia MAS Core Ontology. The term :Signifier is selected instead for the following reasons: 1) Affordances emerge upon the presence of individual agents in the appropriate situation, while signifiers are defined with respect to agent types to preserve the evolvability and reusability of interaction cues without requiring prior knowledge about individual agents; 2) Affordances are defined in [Chemero and Turvey, 2007] for studying interactions of animals, while signifiers are defined here for supporting interactions of autonomous agents, which exhibit more heterogeneous abilities than animals — including agents whose cognitive abilities exclusively rely on computational processes such as reasoning over representations. Here, the concept is provided to support the discussion, management, and modelling of signifiers, which reveal information about affordances [Norman, 2013]. For example, the association between the two terms enables examining the dynamic exposure of signifiers based on the run-time availability of agent abilities and situations, or the modelling of signifiers that reveal information about affordances for both artificial and human agents." ;&#10;skos:historyNote "The definition of the concept follows affordance theorists [Chemero and Turvey, 2007]." ;&#10;skos:prefLabel "affordance" ;&#10;skos:related :Signifier .<br/></pre>|
...
|Title|Terms not labeled|
|Description|The term :Affordance has no rdfs:label to define it in natural language|
|Pointer|<pre lang="Turtle">:Affordance a skos:Concept ;&#10;dct:references "nb155f37cbd5244cd90d28e2dc107970ab1",&#10;"nb155f37cbd5244cd90d28e2dc107970ab2" ;&#10;rdfs:isDefinedBy :core ;&#10;skos:definition "A behavior possibility that is a relationship between an ability of an agent and a situation that includes agents and features of the environment." ;&#10;skos:editorialNote "The concept has been considered as a candidate term for representing interaction cues and metadata in the Hypermedia MAS Core Ontology. The term :Signifier is selected instead for the following reasons: 1) Affordances emerge upon the presence of individual agents in the appropriate situation, while signifiers are defined with respect to agent types to preserve the evolvability and reusability of interaction cues without requiring prior knowledge about individual agents; 2) Affordances are defined in [Chemero and Turvey, 2007] for studying interactions of animals, while signifiers are defined here for supporting interactions of autonomous agents, which exhibit more heterogeneous abilities than animals — including agents whose cognitive abilities exclusively rely on computational processes such as reasoning over representations. Here, the concept is provided to support the discussion, management, and modelling of signifiers, which reveal information about affordances [Norman, 2013]. For example, the association between the two terms enables examining the dynamic exposure of signifiers based on the run-time availability of agent abilities and situations, or the modelling of signifiers that reveal information about affordances for both artificial and human agents." ;&#10;skos:historyNote "The definition of the concept follows affordance theorists [Chemero and Turvey, 2007]." ;&#10;skos:prefLabel "affordance" ;&#10;skos:related :Signifier .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:core a owl:Ontology ;&#10;cc:license <https://creativecommons.org/licenses/by/4.0/> ;&#10;dct:contributor <http://maxime-lefrancois.info/me#>,&#10;<http://ns.inria.fr/fabien.gandon#me>,&#10;<http://w3id.org/people/az/me>,&#10;<https://danaivach.inrupt.net/profile/card#me>,&#10;<https://id.inrupt.com/smnmyr>,&#10;<https://orcid.org/0000-0002-2956-0533>,&#10;<https://orcid.org/0000-0002-4506-2745>,&#10;<https://orcid.org/0000-0003-0821-6095>,&#10;<https://www.vcharpenay.link/#me> ;&#10;dct:creator <https://id.inrupt.com/andreiciortea> ;&#10;dct:description "An ontology to describe Hypermedia Multi-Agent Systems.",&#10;"Une ontologie pour la description de systèmes multi-agents hypermédias." ;&#10;dct:issued "2021-11-21" ;&#10;dct:title "Hypermedia MAS Core Ontology",&#10;"Ontologie Centrale des SMA Hypermédias" ;&#10;vann:preferredNamespacePrefix "hmas" ;&#10;vann:preferredNamespaceUri : .<br/></pre>|
|Pointer|<pre lang="Turtle">:Role a owl:Class ;&#10;rdfs:label "role",&#10;"rôle" ;&#10;rdfs:comment "A Role defines positions of members (i.e., Agents) in an Organization." ;&#10;rdfs:isDefinedBy :regulation .<br/></pre>|
...
|Pointer|<pre lang="Turtle">:signifies a owl:ObjectProperty ;&#10;rdfs:label "signifie",&#10;"signifies" ;&#10;rdfs:comment "A relation between a signifier and a node shape specifying a description of the expected behavior execution." ;&#10;rdfs:domain :Signifier ;&#10;rdfs:isDefinedBy :interaction ;&#10;rdfs:range sh:NodeShape .<br/></pre>|
|Pointer|<pre lang="Turtle">:Signifier a owl:Class ;&#10;rdfs:label "Signifiant",&#10;"Signifier" ;&#10;rdfs:comment "A perceivable sign/cue that can be interpreted meaningfully by an agent to reveal information about a behavior possibility." ;&#10;rdfs:isDefinedBy :core ;&#10;rdfs:seeAlso <https://github.com/HyperAgents/ns.hyperagents.org/issues/13#issuecomment-1028904491>,&#10;<https://github.com/HyperAgents/ns.hyperagents.org/issues/41> ;&#10;skos:note ":Signifier works as a bridge between the Core and the Interaction Vocabularies." ;&#10;skos:related :Affordance .<br/></pre>|
...
|Title|Terms not labeled|
|Description|The term :Affordance has no rdfs:label to define it in natural language|
|Pointer|<pre lang="Turtle">:Affordance a skos:Concept ;&#10;dct:references "n1004ba3147f34a3cbf8a82249ce437b7b1",&#10;"n1004ba3147f34a3cbf8a82249ce437b7b2",&#10;"n56cbb0beccb14d7fb29a1a132f679fb5b1",&#10;"n56cbb0beccb14d7fb29a1a132f679fb5b2" ;&#10;rdfs:isDefinedBy :core ;&#10;skos:definition "A behavior possibility that is a relationship between an ability of an agent and a situation that includes agents and features of the environment." ;&#10;skos:editorialNote "The concept has been considered as a candidate term for representing interaction cues and metadata in the Hypermedia MAS Core Ontology. The term :Signifier is selected instead for the following reasons: 1) Affordances emerge upon the presence of individual agents in the appropriate situation, while signifiers are defined with respect to agent types to preserve the evolvability and reusability of interaction cues without requiring prior knowledge about individual agents; 2) Affordances are defined in [Chemero and Turvey, 2007] for studying interactions of animals, while signifiers are defined here for supporting interactions of autonomous agents, which exhibit more heterogeneous abilities than animals — including agents whose cognitive abilities exclusively rely on computational processes such as reasoning over representations. Here, the concept is provided to support the discussion, management, and modelling of signifiers, which reveal information about affordances [Norman, 2013]. For example, the association between the two terms enables examining the dynamic exposure of signifiers based on the run-time availability of agent abilities and situations, or the modelling of signifiers that reveal information about affordances for both artificial and human agents." ;&#10;skos:historyNote "The definition of the concept follows affordance theorists [Chemero and Turvey, 2007]." ;&#10;skos:prefLabel "affordance" ;&#10;skos:related :Signifier .<br/></pre>|
